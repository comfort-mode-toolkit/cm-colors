...
class CMColors:
    ...
    def tune_colors(self, text_rgb, bg_rgb, large_text: bool = False, details: bool = False):
        """
...
if __name__ == "__main__":
    ...
    print(f"WCAG Level: {detailed_result['wcag_level']}, Improvement: {detailed_result['improvement_percentage']:.1f}%\n")
    ...
    # Simple check
    tuned_good, is_accessible_good = cm_colors.tune_colors(text_color_good, bg_color_good)
    ...
    tuned_large, accessible_large = cm_colors.tune_colors(text_large, bg_large, large_text=True)
    detailed_large = cm_colors.tune_colors(text_large, bg_large, large_text=True, details=True)
